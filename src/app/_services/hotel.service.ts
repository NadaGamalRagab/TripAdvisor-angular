  ...
  hotels: Hotel[] = [
    {
      ...
      deals: ['Free Cancellation', 'Reserve now, pay at stay'],
      amenities: [
        'Free Parking',
        'Pool',
        'Free Wifi',
      ...
      languageSpoken: ['English', 'French', 'Spanish', 'Arabic', 'German'],
    },

    {
      ...
      languageSpoken: ['English', 'French', 'Arabic'],
    },

    {
      ...
      languageSpoken: ['English', 'French', 'Spanish', 'Arabic'],
    },
